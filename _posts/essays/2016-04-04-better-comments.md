...
exchange of letters or telephonic conversations. Since the 1990s though, the marketing tools have transformed and the most
...
Although this somewhat helps comments posted at a later timestamp, it obviously doesn't address the issue about the quality of the comments on Reddit which have been degrading consistently over the last few years. This isn't surprising since any community that grows exponentially will generally bring more noise than signal. And its not just the quality that has degraded. There is also the issue of lack of diversity. Contrary opinions are just not very welcome once you have a majority that flourishes by seeings things in black and white. So downvotes end up meaning disagreements (even though there original intent was to weed out trolls) and bury a contrarian viewpoint into oblivion even if it was articulated eloquently, in turn converting a forum into an [echo chamber](https://en.wikipedia.org/wiki/Echo_chamber_%28media%29). Small communities within reddit (called subreddits) never attract a large audience and hence still remain great places to hang out in but they provide no mechanism other than the "report" button or heavy moderation (which can go terribly wrong) to **encourage** rational discourse. 
...
some degradation in quality and there are [reasonable complaints](http://mjg59.dreamwidth.org/28232.html) about HN being an echo chamber too. But at least its run by people who welcome contructive criticism and are always [looking to improve the system](https://news.ycombinator.com/item?id=7605973).
